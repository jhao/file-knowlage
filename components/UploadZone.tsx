    ...
    <div className="p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex gap-4">
        ...
        >
          ...
          <p className="text-slate-500 mt-2 text-center text-sm">点击或拖拽文件至此</p>
        </div>
        ...
        >
          ...
          <p className="text-slate-500 mt-2 text-center text-sm">批量导入目录下的所有文件</p>
        </div>
      </div>
            ...
            {selectedFiles.map((file, idx) => (
              <li key={idx} className="px-6 py-3 flex items-center justify-between hover:bg-slate-50">
                <div className="flex items-center gap-3">
                  <div className="bg-slate-100 p-2 rounded text-slate-500">{getFileIcon(file.type)}</div>
                  <div>
